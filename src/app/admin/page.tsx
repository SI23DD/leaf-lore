...
const statusColors: Record<string, string> = {
  Delivered: '#C82333', Processing: '#666666', Shipped: '#1F618D',
...
export default function AdminDashboard() {
  ...
  const statCards = [
    { label: 'Total Books', value: stats?.totalBooks ?? '—', icon: '📚', color: '#C82333' },
    { label: 'Total Orders', value: stats?.totalOrders ?? '—', icon: '📦', color: '#666666' },
