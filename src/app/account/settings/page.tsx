    ...
    <>
      <style>{`
        @media (max-width: 768px) {
          ...
          .delete-modal-inner { padding: 20px !important; }
        }
      ...
      <div style={{ backgroundColor: '#F8F9FA', minHeight: '100vh', padding: '40px 24px', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
        ...
        {showDeleteModal && (
          ...
          >
            <div
              className="animate-scaleIn delete-modal-inner"
              style={{
                backgroundColor: '#FFFFFF',
                borderRadius: '10px',
                padding: '28px',
        ...
        <div className="account-layout" style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', gap: '32px', alignItems: 'flex-start' }}>
          ...
          <main style={{ flex: 1, minWidth: 0 }}>
            <div className="account-mobile-nav">
              <AccountMobileNav onOpen={() => setSidebarOpen(true)} pageTitle="Settings" />
            </div>
            ...
            <SectionCard title="Preferences" icon="🌍" delay="delay-200">
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px', padding: '7px 0', flexWrap: 'wrap' }}>
                <div>
